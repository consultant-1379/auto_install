...
public class ManageInstallServiceAddInteractiveTestSteps extends TorTestCaseHelper {

    private final static Logger logger = LoggerFactory.getLogger(ManageInstallServiceAddInteractiveTestSteps.class);
    ...
    @TestStep(id = "manageInstallServiceAddInteractive")
    public void testManageInstallService() throws InterruptedException {
        setTestStep("manageInstallServiceAddInteractive");
        ...
        boolean exit1 = upgOperator.callmanageInstallServiceAddInteractive(mediaPath);
        assertTrue(exit1);
